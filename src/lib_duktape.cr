...
lib LibDUK
  ...
  COMPILE_EVAL       = (1 << 3).to_u32
  COMPILE_FUNCTION   = (1 << 4).to_u32
  COMPILE_STRICT     = (1 << 5).to_u32
  COMPILE_SAFE       = (1 << 6).to_u32
  COMPILE_NORESULT   = (1 << 7).to_u32
  COMPILE_NOSOURCE   = (1 << 8).to_u32
  COMPILE_STRLEN     = (1 << 9).to_u32
  COMPILE_NOFILENAME = (1 << 10).to_u32
